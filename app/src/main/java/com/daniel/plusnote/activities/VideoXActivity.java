...
public class VideoXActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        select_existing_image_video.setOnClickListener(view -> {
...
//                .setTargetResolution(new Size(2160, 3840))
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_CODE_STORAGE_PRM && grantResults.length > 0) {
            ...
            if (data != null) {
                ...
                if (selectedImageUri != null) {
                    try {
                        ...
                        CameraXActivity.fromGallery = true;
                        isVideo = false;
